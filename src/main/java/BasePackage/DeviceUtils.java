...
public class DeviceUtils {
    ...
    Logger logger = Logger.getLogger(String.valueOf(DeviceUtils.class));

    public DeviceUtils(AppiumDriver<MobileElement> driver) {
        this.driver = driver;
    }
...
//    public DeviceUtils(AppiumDriver appiumDriver) {
